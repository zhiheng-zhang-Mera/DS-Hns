...
Current inventory: 7 claim rows (6 supported engineering claims, 1 explicitly unsupported comparator claim), 12 experiment rows including two `NOT_RUN`, and 16 negative-result rows. Counts describe catalog entries, not statistical samples.
