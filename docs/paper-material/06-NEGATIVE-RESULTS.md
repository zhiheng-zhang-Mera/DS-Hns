...
| N43 | With opt-in `DSH_MEGA_INTEGRATED_DOCK=1`, expanded dock obscured most of the first-run disclosure Continue control | `artifacts/acceptance/FINAL_UI_ISSUE_INVENTORY.json`; `D:\HnsQ24\journey-dafd3bf\OPT_IN_DOCK_P2_TRIAGE.md` | retain as open P2; safe correction needs official-surface layout work and renewed qualification; no speculative offset patch |
