...
- a passing qualification from `D:\Hns-Cleanroom-Qualification-12\repo`, freshly cloned from the remote candidate branch (planned location; existence and PASS must be verified from its immutable summary);
