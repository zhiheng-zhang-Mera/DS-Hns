...
| Exact-candidate 24-hour observation | `artifacts/qualification/REALTIME_24H_SOAK.json` + `D:\qf\realwallclock-4ef9c0d-20260925\real-wallclock-samples.jsonl` | `IN_PROGRESS_PARTIAL`; 168 samples over 10,020.009 seconds at snapshot `2026-09-25T09:46:04.8986324Z`; runtime/Electron/Harness ready in all samples; liveness/resources only; two UI smokes uncorrelated |
