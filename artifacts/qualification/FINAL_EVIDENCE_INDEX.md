...
- a passing qualification from `D:\Hns-Cleanroom-Qualification-9\repo`, freshly cloned from the remote candidate branch (planned location; existence and PASS must be verified from its immutable summary);
